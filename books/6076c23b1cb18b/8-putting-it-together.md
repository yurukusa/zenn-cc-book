---
title: "19点→85点の全工程——ここまでやって初めて安心して眠れた"
free: false
---
...
これだけで8個のコアhook + プロジェクト検出 + 推奨hookが全てインストールされる。667個以上のhookから最適な組み合わせを自動選択する。
...
ルールをCLAUDE.mdに書いても守られないことがある。GitHubでは[2,100件以上のリアクション](https://github.com/anthropics/claude-code/issues/42796)が付いたIssueで「指示が無視される」問題が報告されている。これは設定ミスではなく、LLMの構造的な限界だ。でもhookでブロックすれば物理的に止まる。監視ツールを入れれば問題を知ることができる。ログがあれば原因を追える。
...
**667個以上のexample hookからプロジェクトに合ったものを追加**:
