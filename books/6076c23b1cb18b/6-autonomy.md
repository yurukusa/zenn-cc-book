...
**対策**: `templates/task-queue.yaml` を `~/ops/` に配置する。

**[task-queue.yaml を入手](https://github.com/yurukusa/claude-code-hooks/blob/main/templates/task-queue.yaml)**
...
**[no-ask-human.sh を入手](https://github.com/yurukusa/claude-code-hooks/blob/main/hooks/no-ask-human.sh)**
...
**対策**: `templates/mission.md` を `~/ops/` に配置する。

**[mission.md テンプレートを入手](https://github.com/yurukusa/claude-code-hooks/blob/main/templates/mission.md)**
