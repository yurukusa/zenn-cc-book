---
title: "hookのテスト——14,078テストケースから学んだ品質保証"
---
...
cc-safe-setupには655個のexample hookがある。初期（当時511個）は118個しかテストがなかった。残り393個は「たぶん動く」状態だった。
...
1. **テストされていないhookは信頼できない**。655個のhookをテストなしで配布していた期間は、品質を保証できなかった
