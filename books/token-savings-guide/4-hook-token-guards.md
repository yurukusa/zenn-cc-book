...
これらのhookを全部自分で書く必要はない。cc-safe-setupには691以上のexample hookが用意されており、[examples/](https://github.com/yurukusa/cc-safe-setup/tree/main/examples)からダウンロードして使える。一括インストールは`npx cc-safe-setup`。
