...
Claude CodeのUI下部にあるステータスバーでセッションのトークン消費を確認できる。また、[Anthropicダッシュボード](https://console.anthropic.com/settings/usage)でAPIレベルの消費も確認可能。キャッシュが効いているときと壊れているときで、1ターンあたりの消費に顕著な差がある。
